...
def WCDA_response_factory(response_file_name):
    """
    ...
    if not response_file_name in _instances:
        ...
        if extension == ".root":
            ...
            new_instance = WCDAResponse.from_root_file(response_file_name)

        elif extension in [".hd5", ".hdf5", ".hdf"]:

            new_instance = WCDAResponse.from_hdf5(response_file_name)
    ...
    return _instances[response_file_name]  # type: WCDAResponse


class WCDAResponse(object):
    ...
    def from_hdf5(cls, response_file_name):
        ...
        use the WCDA_response_factory function instead.
    ...
    def from_root_file(cls, response_file_name: Path):
        ...
        Returns:
            WCDAResponse: returns a WCDAResponse instance
        """
