...
python3.9 /data/home/cwy/Science/3MLWCDA/Standard/src/tools/llh_skymap/pixfitting_spec_index.py --area ${no} -m /data/home/cwy/Science/3MLWCDA/data/20210305-20230731_trans_fromhsc.root -r /data/home/cwy/Science/3MLWCDA/data/DR_ihep_MK2_newoldDRpsf.root #WCDA
